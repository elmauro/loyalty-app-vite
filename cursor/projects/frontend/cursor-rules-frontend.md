...
> **Uso con prompts:** adjunta con `@` para trabajo frontend. **Rutas** de código: repo **loyalty-app-vite**.

Practical rules for generating and updating code in this repository. Use together with `project-context.md` in this folder (loyalty-cursor).
